...
import { Eye, Trophy, Calendar, Users, Gift, Search, UsersRound } from "lucide-react";
  ...
  useEffect(() => {
    async function fetchChallenges() {
      try {
        ...
        const params = {
          module: "together" // Always filter by together (family) module
        };
        if (statusFilter !== "all") {
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Family Challenges</h1>
          <p className="text-muted-foreground mt-1">
            View all challenges created by family members
          </p>
        </div>
      </div>
                    ...
                    {paginatedChallenges.map((challenge) => (
                      <TableRow key={challenge._id}>
                        ...
                        <TableCell className="text-right">
                          <Link href={`/admin/families/challenges/${challenge._id}`}>
